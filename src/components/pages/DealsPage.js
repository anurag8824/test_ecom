            ...
            <div className='grid grid-col-2 md:grid-cols-2 gap-4'>
                ...
                <div class=" mx-10 mt-10 mb-4 flex max-w-xs flex-col overflow-hidden border border-gray-100 bg-white ">
                    ...
                    <div class="mt-4 px-5 pb-5">
                        ...
                        <a href="/product" class="flex items-center justify-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
