                ...
                <div class="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
                    <div class="w-full grid grid-cols-2 gap-4">
                        ...
                        <div className='border'>
                            ...
                            <div class="pt-11 pb-8 border-b  max-xl:max-w-2xl max-xl:mx-auto">
                                ...
                                <p class="font-normal text-md leading-8 text-gray-400 max-xl:text-justify">One of the standout features of Pagedone is its intuitive and user-friendly interface. Navigating through the system feels natural, and the layout makes it easy to locate and utilize various design elements. This is particularly beneficial for designers looking to streamline their workflow.</p>
                            </div>
                        ...
                        <div className='border'>
                            ...
                            <div class="pt-8 max-xl:max-w-2xl max-xl:mx-auto">
                                ...
                                <p class="font-normal text-md leading-8 text-gray-400 max-xl:text-justify">Pagedone doesn't disappoint when it comes to the variety and richness of its design components. From pre-built templates to customizable elements, the system caters to both beginners and seasoned designers. The extensive library ensures a diverse range of options to bring creative visions to life.</p>
                            </div>
